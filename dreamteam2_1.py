...
#uniques = {3,13,15,27,1,4,23,19,12,9,2,17}
...
for i in keys_values:
   if type(i) == str:
        a_list.append(i)
for n in keys_values:
    if type(n) == int:
        n_list.append(n)
a = dict(zip(a_list, n_list))
print(a_list, n_list)
print(a)'''
...
#####################################################################
print("Сумма и срок вашего вклада при ставке 10% годовых")
a = int(input("Сумма: "))
years = int(input("Количество годов: "))

def bank(a, years, b = 10):
   sum = a*(1+b/100)**years
   return(f'Вместе с первоначальным взносом сумма на вашем счету составит {sum} сома(ов).')
...
print("Средняя температура воздуха за", days, "дней равна", (total/days))
